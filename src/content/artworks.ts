...
export const artworks: Artwork[] = [
  {
    ...
    coverImage: '/artworks/ToucanStudy.webp',
    images: ['/artworks/ToucanStudy.webp'],
    tags: ['Krita'],
  },
  {
    title: 'Elemental Stone',
    description: 'A drawing of an elemental stone with surging powers.',
    coverImage: '/artworks/NewStoneBG.webp',
    images: ['/artworks/NewStoneBG.webp'],
    tags: ['Photoshop'],
  },
  {
    title: 'Queen Slime',
    description: 'An astonishing view of a queen slime holding the staff of the slime heresy.',
    coverImage: '/artworks/SlimeQueenFinished.webp',
    images: ['/artworks/SlimeQueenFinished.webp'],
    tags: ['Aseprite'],
  },
]
